...
public class ElasticArray801<T> implements Cis2168List<T> {
  ...
  ElasticArray801() {
    // this.storage = new T[INITIAL_CAPACITY];
  ...
  private void grow() {
    ...
    int largerCapacity = currentCapacity + 4;

    // IDEA 1:  largerCapacity = currentCapacity + 1
    // IDEA 2:  largerCapacity = currentCapacity + 4
    // IDEA 3:  largerCapacity = currentCapacity * 2
    // IDEA 4:  largerCapacity = currentCapacity * 4
  ...
  public void add(T element) {
    // 1. ensure storage has enough capacity for the new element
  ...
  public int indexOf(T element) {
    for(int i = 0; i < this.count; i++) {
      ...
      // Objects.equal(this.storage, element)
  ...
  public void delete(T element) {
    int elementIdx = this.indexOf(element);
    if (elementIdx >= 0) {
      this.remove(elementIdx);
    }
  }
